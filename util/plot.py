...
test_folder = '/home/rui/work/drop-percentage-model/data/test/'
test_dataset = DropPercentDataset(test_folder)

test_dataloader  = torch.utils.data.DataLoader(test_dataset,
                                                batch_size=None,
                                                batch_sampler=None)

model_path = '/home/rui/work/drop-percentage-model/check_points/2022-12-18 15:42:47/epoch_977_0.37310895323753357'
...
with torch.no_grad():
    for idx, data in enumerate(test_dataloader):
        x = data['x'].float()
        y = data['y'].float()
        yhat = model(x.reshape(1, x.shape[0], -1))
